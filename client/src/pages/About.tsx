      ...
      <div className="min-h-screen pt-16 pb-20">
        ...
        <section className="flex flex-col justify-center px-4 h-full">
          <div className="max-w-4xl mx-auto w-full">
            ...
            {/* Credentials Grid */}
            <div className="grid md:grid-cols-3 gap-3 mb-4 flex-shrink-0">
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-3 border border-white/25 text-center">
            ...
            {/* Approach Section */}
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 mb-4 flex-shrink-0">
              <h2 className="text-lg font-bold text-white text-center mb-3">Our Approach</h2>
              <div className="grid sm:grid-cols-3 gap-3">
                <div className="text-center">
                  ...
                  <h3 className="text-white font-bold text-xs mb-1">Compassionate</h3>
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-white font-bold text-xs mb-1">Practical</h3>
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-white font-bold text-xs mb-1">Sustainable</h3>
            ...
            <div className="text-center flex-shrink-0">
              <h3 className="text-base font-bold text-white mb-2">Ready to Start Your Journey?</h3>
              <div className="flex flex-col sm:flex-row gap-2 justify-center">
                ...
                <Link href="/services">
                  <Button variant="outline" size="sm" className="px-3 py-1.5 border-white/50 text-white hover:bg-white/20 text-xs font-semibold">
                    View Services
                  </Button>
                </Link>
              </div>
