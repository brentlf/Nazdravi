      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <section className="mb-20 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="serif-body text-xl text-muted-foreground mb-8 leading-relaxed max-w-3xl mx-auto">
              I'm here to help you discover that healthy eating can be
              delicious, sustainable, and perfectly tailored to your life. Let's
              transform your relationship with food together.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1 relative">
              ...
              <div className="absolute top-8 left-8 bg-white/90 backdrop-blur-sm p-3 rounded-full shadow-lg floating-element">
                <span className="font-display text-primary italic text-sm">
            ...
            <div className="space-y-6 order-1 lg:order-2">
              ...
              <p className="serif-body text-lg text-muted-foreground leading-relaxed">
                I believe that healthy eating shouldn't feel like a
                punishment—it should be enjoyable, nourishing, and perfectly
                tailored to your unique lifestyle. My approach combines
                evidence-based nutrition science with real-world practicality,
                because I know how challenging it can be to maintain healthy
                habits in our busy lives.
              </p>

              <p className="serif-body text-lg text-muted-foreground leading-relaxed">
                Whether you're looking to improve your energy levels, manage a
                health condition, or simply feel more confident in your food
                choices, I'm here to guide you every step of the way. Together,
                we'll create a sustainable path to wellness that fits seamlessly
                into your life.
              </p>
              ...
              <div key={index} className="text-center relative">
                <Card className="mediterranean-card p-6 floating-element">
                  <CardContent className="p-0 relative">
                    ...
                    <p className="serif-body text-sm text-muted-foreground">
                      {stat.label}
                    </p>
                  </CardContent>
                </Card>
              ...
              return (
                <div key={index} className="relative">
                  <Card className="mediterranean-card p-6 h-full floating-element">
                    <CardContent className="p-0 relative">
                      <div className="w-12 h-12 bg-gradient-to-br from-primary/20 to-accent/20 blob-shape flex items-center justify-center mb-4 floating-element bg-green-500/50">
                        <Icon className="w-6 h-6 text-green-800" />
                      </div>
                      <h3 className="font-display text-xl mb-3 handwritten-accent">
                        {value.title}
                      </h3>
                      <p className="serif-body text-muted-foreground leading-relaxed">
                        {value.description}
                      </p>
        ...
        <section className="text-center">
          <div className="max-w-2xl mx-auto">
            <h2 className="font-display text-3xl font-bold mb-4 handwritten-accent">
            ...
            <Button size="lg" asChild className="mediterranean-card ">
              <Link href="/register">Start Your Transformation</Link>
            </Button>
            <p className="serif-body text-sm text-muted-foreground mt-6">
              No pressure, no judgment—just genuine support for your wellness
              goals.
            </p>
          </div>
        </section>
