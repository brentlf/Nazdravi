      ...
      try {
        ...
        if (userSnap.exists()) {
          ...
          healthData = {
            ...
            height: userData.height || userData.heightCm || "",
            weight: userData.currentWeight || userData.weight || "",
            ...
            availableTimeForCooking: userData.availableTimeForCooking || userData.availableCookingTime || "",
